...
from PyQt6.QtWidgets import (
    ...
    QLineEdit, QPushButton, QMessageBox, QListWidget, QApplication)
...
class ContactApp(QMainWindow):
    ...
    def delete_contact(self):
        ...
        if current_item:
            selected_name = current_item.text()
            confirm = QMessageBox.question(self, 'Konfirmasi', f'Anda yakin ingin menghapus kontak {selected_name}?', QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
